...
#include <stdlib.h>
#include <conio.h>
//cuando creamos la biblioteca, lo busca en el main.
...
char letra;
printf("\nIngrese opcion...S/N?");
letra=toupper(getche());//con esta funcion no espera el enter y toma un dato//como un caracter y lo paso a mayusculas
